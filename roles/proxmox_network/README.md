...
```yaml
proxmox_network_api_token_id:     "{{ vault_proxmox_api_token_id }}"
proxmox_network_api_token_secret: "{{ vault_proxmox_api_token_secret }}"
# or
proxmox_network_api_user:     "root@pam"
proxmox_network_api_password: "{{ vault_proxmox_api_password }}"
```
...
```yaml
proxmox_network_api_host: "pve2.example.com"   # optional — overrides the shared proxmox_api_host
```
...
- name: Configure node networking
  ...
  roles:
    - role: mgcdrd.infrabase.proxmox_network
      vars:
        proxmox_network_api_host:         "pve2.example.com"
        proxmox_network_api_token_id:     "{{ vault_proxmox_api_token_id }}"
        proxmox_network_api_token_secret: "{{ vault_proxmox_api_token_secret }}"
